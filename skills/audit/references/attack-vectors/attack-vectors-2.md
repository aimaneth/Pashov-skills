...
**44. Self-Liquidation Profit Extraction**
...
**45. State-Time Lag Exploitation (lzRead Stale State)**
...
**47. Function Selector Clashing (Proxy Backdoor)**
...
**48. OFT Shared Decimals Truncation (uint64 Overflow)**
...
**49. UUPS Upgrade Logic Removed in New Implementation**
...
**50. ERC721 onERC721Received Arbitrary Caller Spoofing**
...
**51. ERC1155 totalSupply Inflation via Reentrancy Before Supply Update**
...
**52. Missing Nonce (Signature Replay)**
...
**54. Diamond Proxy Cross-Facet Storage Collision**
...
**55. Force-Feeding ETH via selfdestruct / Coinbase / CREATE2 Pre-Funding**
...
**56. Wrong Price Feed for Derivative or Wrapped Asset**
...
**57. ERC4626 Preview Rounding Direction Violation**
...
**58. Block Number as Timestamp Approximation**
...
**59. Transparent Proxy Admin Routing Confusion**
...
**60. Cross-Chain Address Ownership Variance**
...
**62. Bytecode Verification Mismatch**
...
**63. Scratch Space Corruption Across Assembly Blocks**
...
**66. ERC1155 Fungible / Non-Fungible Token ID Collision**
...
**67. ERC4626 Deposit/Withdraw Share-Count Asymmetry**
...
**68. ERC4626 Mint/Redeem Asset-Cost Asymmetry**
...
**69. ERC1155 Batch Transfer Partial-State Callback Window**
...
**70. Chainlink Staleness / No Validity Checks**
...
**71. Unsafe Downcast / Integer Truncation**
...
**72. Missing `enforcedOptions` — Insufficient Gas for lzReceive**
...
**73. Nonce Gap from Reverted Transactions (CREATE Address Mismatch)**
...
**74. Fee-on-Transfer Token Accounting**
...
**75. Assembly Delegatecall Missing Return/Revert Propagation**
...
**76. Merkle Tree Second Preimage Attack**
...
**77. Dirty Higher-Order Bits on Sub-256-Bit Types**
...
**78. Griefing via Dust Deposits Resetting Timelocks or Cooldowns**
...
**79. Returndatasize-as-Zero Assumption**
...
**81. ERC20 Non-Compliant: Return Values / Events**
...
**82. ERC721Enumerable Index Corruption on Burn or Transfer**
...
**83. Block Stuffing / Gas Griefing on Subcalls**
...
**84. ERC777 tokensToSend / tokensReceived Reentrancy**
...
**85. Rebasing / Elastic Supply Token Accounting**
